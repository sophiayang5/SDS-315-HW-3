...
# graph the difference in mean annoyedness according to the show
ggplot(boot_nbc_annoyed) + geom_histogram(aes(x = diffmean)) + 
  labs(
    title = "Annoyedness between \"The Biggest Loser\" and \"The Apprentice: Los Angeles\" ",
...
ggplot(boot_ebay_ratio) + geom_histogram(aes(x = diffmean)) + 
  labs(
    title = "Revenue Ratio Between Paid Google Search and Non-Paid Google Search",
